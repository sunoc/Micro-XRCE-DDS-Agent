...
static int
zynqmp_linux_r5_proc_irq_handler(int vect_id, void *data)
{
...
static void
zynqmp_linux_r5_proc_remove(struct remoteproc *rproc)
{
  struct remoteproc_priv *prproc;
  struct metal_device *dev;
...
static int
zynqmp_linux_r5_proc_notify(struct remoteproc *rproc, uint32_t id)
{
  struct remoteproc_priv *prproc;
