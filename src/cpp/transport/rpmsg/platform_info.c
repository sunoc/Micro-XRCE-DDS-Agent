...
int
platform_init(int argc, char *argv[], void **platform)
{
...
void
platform_release_rpmsg_vdev(struct rpmsg_device *rpdev, void *platform)
{
...
void
platform_cleanup(void *platform)
{
  struct remoteproc *rproc = platform;
