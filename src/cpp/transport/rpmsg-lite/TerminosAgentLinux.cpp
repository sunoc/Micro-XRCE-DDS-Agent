...
*
*******************************************************************************/
void TermiosRPMsgLiteAgent::send_shutdown(int filedescriptor)
{
...
*
*******************************************************************************/
int TermiosRPMsgLiteAgent::rpmsg_create_ept(int rpfd, rpmsg_endpoint_info *ept)
{
  int ret;
...
*
*******************************************************************************/
char *TermiosRPMsgLiteAgent::get_rpmsg_ept_dev_name(const char *rpmsg_name,
				    const char *ept_name,
...
*
*******************************************************************************/
int TermiosRPMsgLiteAgent::bind_rpmsg_chrdev(const char *rpmsg_name)
{
...
*
*****************************************************************************/
int TermiosRPMsgLiteAgent::get_rpmsg_chrdev_fd(const char *rpmsg_name,
...
*
*****************************************************************************/
void TermiosRPMsgLiteAgent::set_src_dst(char *out, rpmsg_endpoint_info *pep)
{
  long dst = 0;
...
*
*****************************************************************************/
void TermiosRPMsgLiteAgent::lookup_channel(char *out, rpmsg_endpoint_info *pep)
{
